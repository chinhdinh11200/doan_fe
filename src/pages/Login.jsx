...
export default function Login() {
    return (
        <div className='relative h-screen flex justify-center items-center max-w-[400px] w-full m-auto'>
            <div
                class="absolute max-h-[400px] m-auto inset-0 bg-gradient-to-r from-blue-300 to-blue-600 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
            </div>
            <form className='relative bg-white w-full p-4 rounded-3xl'>
                ...
                <div className='flex flex-col py-2'>
                    <input className='text-sm border border-gray-200' type="text" placeholder='Mã Nhân Viên' />
                </div>
                <div className='flex flex-col py-2'>

                    <input className='text-sm border border-gray-200' type="password" placeholder='Mật Khẩu' />
                </div>
