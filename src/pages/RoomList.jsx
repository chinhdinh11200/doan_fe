...
function RoomList() {
  ...
  const columns = [
    ...
    {
      title: <div className="text-center">Tên phòng thi</div>,
      dataIndex: "name",
      key: "name",
    ...
    {
      title: <div className="text-center">Mã phòng thi</div>,
      dataIndex: "code",
      key: "code",
      sortDirections: ["descend", "ascend", "descend"],
      sorter: () => { },
    ...
    // {
    //   title: <div className="text-center">Kì thi</div>,
    //   dataIndex: "semester",
    //   key: "semester",
    //   sortDirections: ["descend", "ascend", "descend"],
    //   sorter: () => { },
        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            <div className="container max-w-7xl mx-auto mt-3">
              <div className="mb-4">
                <h1 className="font-serif w-fit text-2xl pb-1 mb-8 mx-auto text-center font-bold uppercase border-b border-gray-300">Danh sách phòng thi</h1>
