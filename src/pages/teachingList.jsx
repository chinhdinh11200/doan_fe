        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-4 w-full max-w-9xl mx-auto">
            <div className="container max-w-7xl mx-auto mt-3">
              <div className="mb-4">
                <h1 className="font-serif w-fit text-2xl pb-1 mb-8 mx-auto text-center font-bold uppercase border-b border-gray-300">Danh sách giảng dạy</h1>
                <div className="flex justify-between flex-row-reverse gap-4">
                <div className='flex gap-2'>
                  <Search onChangeSearch={onChangeSearch} />
                  <FilterButton />
                </div>
                  <NavLink end to='/add-teaching' className="btn bg-indigo-500 hover:bg-indigo-600 text-white">
