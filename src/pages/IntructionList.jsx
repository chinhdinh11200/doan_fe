        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            <div className="container max-w-7xl mx-auto mt-3">
              <div className="mb-4">
                <h1 className="font-serif text-2xl pb-2 text-center font-bold underline decoration-gray-400 capitalize">Danh sách Hướng dẫn sinh viên NCKH, huấn luyện đội tuyển </h1>
                    ...
                    <table className="min-w-full">
                      <thead>
                        <tr>
                          ...
                          <th
                            className="px-4 py-2 text-xs font-medium leading-4 tracking-wider text-center text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                            Kết quả bảo vệ cấp khoa</th>
                          <th
                            className="px-4 py-2 text-xs font-medium leading-4 tracking-wider text-center text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                            Kết quả bảo vệ cấp học viện</th>
