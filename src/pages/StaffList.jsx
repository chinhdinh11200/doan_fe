...
import { PAGE_SIZE, POSITION_STAFF } from '../constants';
...
function staffList() {
  ...
  const [staffDetailId, setStaffDetailId] = React.useState(0);
  ...
  return (
    <div className="flex h-screen overflow-hidden">
        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-4 w-full max-w-9xl mx-auto">
            <div className="container max-w-7xl mx-auto mt-3">
              <div className="mb-4">
                <h1 className="font-serif w-fit text-2xl pb-1 mb-8 mx-auto text-center font-bold uppercase border-b border-gray-300">Danh sách nhân viên</h1>
      ...
      <>
        {showModal ? (
          <ModalDetail setShowModal={setShowModal} staffId={staffDetailId} />
        ) : null}
      </>
    </div>
  );
...
const ModalDetail = ({ staffId, setShowModal }) => {
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full p-6 bg-white outline-none focus:outline-none">
            ...
            <div className="relative border">
              <div className="flex justify-between py-2 pl-2 border-b">
                <p className="w-1/2 break-words">Mã nhân viên:</p>
                <p className="w-1/2 break-words">{dataStaff?.code}</p>
              </div>
              <div className="flex justify-between py-2 pl-2 border-b">
                <p className="w-1/2 break-words">Tên nhân viên:</p>
                <p className="w-1/2 break-words">{dataStaff?.name}</p>
              </div>
              <div className="flex justify-between py-2 pl-2 border-b">
