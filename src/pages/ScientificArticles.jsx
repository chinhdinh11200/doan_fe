...
function Dashboard() {
  ...
  const columns = [
    ...
    {
      title: <div className="text-center">SỐ NGƯỜI HƯỚNG DẪN</div>,
  ...
  const { data: { data: dataUser = [], total } = {}, isLoading } = useArticleList(tableParams);
  const { mutate, isLoading: isLoadingDelete, isSuccess } = useArticleDelete();
        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            <div className="container max-w-7xl mx-auto mt-3">
              <div className="mb-4">
                <h1 className="font-serif w-fit text-2xl pb-1 mb-4 mx-auto text-center font-bold uppercase border-b border-gray-300">Danh sách bài báo khoa học</h1>
