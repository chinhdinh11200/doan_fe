...
function Dashboard() {
    ...
    return (
        <div className="flex h-screen overflow-hidden">
           ...
           text-white hover:text-slate-800 hover:bg-white hover:border-slate-800'>Thêm chương trình đào tạo</span></div>
                    <div className="w-full">
                        <div className="border-b border-gray-900/10 pb-12">
                        <div className="col-span-full my-3">
                                <label for="CountPerson" className="block text-sm font-medium leading-6 text-gray-900 capitalize">Tên chương trình đào tạo</label>
                                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            ...
                            <div className="col-span-full my-3">
                                <label for="course" className="block text-sm font-medium leading-6 text-gray-900 capitalize">số quyết định giao nhiệm vụ</label>
                                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            ...
                            <div className="col-span-full my-3">
                                <label for="numberDecide" className="block text-sm font-medium leading-6 text-gray-900 capitalize">số thành viên</label>
                                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            ...
                            <fieldset>
                                <legend className=" text-sm font-semibold leading-6 text-gray-900 capitalize">Chọn hình thức</legend>
                                <div className="mt-2 space-y-2">
                                    <div className="relative flex gap-x-3">
                                        ...
                                        <div className="text-sm leading-6">
                                            <label for="main" className="font-medium text-gray-900">tu sửa</label>
                                        </div>
                                    </div>
                                    <div className="relative flex gap-x-3">
                                        <div className="flex h-6 items-center">
                                        ...
                                        <div className="text-sm leading-6">
                                            <label for="common" className="font-medium text-gray-900">Làm mới</label>
                            ...
                            <div className="col-span-full my-3">
                                <label for="numberDecide" className="block text-sm font-medium leading-6 text-gray-900 capitalize">ngày kí quyết định</label>
                                <div className="mt-2">
