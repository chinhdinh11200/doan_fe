...
import { POSITION_STAFF, RESULT_FACULTY, RESULT_ACADEMY, YEAR_ID, SEMESTER } from '../../constants';
              ...
              <Controller
                ...
                render={({ field: { value, onChange, ref } }) => (
                  <Select
                    ...
                    onChange={(val) => {
                      onChange(val);
                      setValue("result_academy", val.value);
                    }}
                  />
                )}
              />
