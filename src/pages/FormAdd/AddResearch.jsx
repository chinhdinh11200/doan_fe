          ...
          <div className="w-full">
            ...
            <div className="col-span-full my-3">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
              ...
              <div className="col-span-full my-3">
                <label for="CountPerson" className="block text-sm font-medium leading-6 text-gray-900 capitalize"> Mã Dự án</label>
                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              ...
              <div className="col-span-full my-3">
                <label for="name" className="block text-sm font-medium leading-6 text-gray-900 capitalize"> Tên đề tài/ dự án</label>
                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              ...
              <div className="col-span-full my-3">
                <label for="course" className="block text-sm font-medium leading-6 text-gray-900 capitalize">Số người tham gia</label>
                <div className="mt-2">
                  <input type="number" name="course" id="course" autocomplete="course" className="block w-full
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                </div>
              </div>
              <div className='grid grid-cols-2'>
              <fieldset>
                <legend className=" text-sm font-semibold leading-6 text-gray-900 capitalize">vai trò</legend>
                <div className="mt-2 space-y-2">
                  <div className="relative flex gap-x-3">
                    <div className="flex h-6 items-center">
                      <input id="main" name="main" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600" />
                    ...
                    <div className="text-sm leading-6">
                      <label for="main" className="font-medium text-gray-900 capitalize">Chủ trì
</label>
                    </div>
                  </div>
                  <div className="relative flex gap-x-3">
                    ...
                    <div className="text-sm leading-6">
                      <label for="main" className="font-medium text-gray-900 capitalize"> Thư ký</label>
                    </div>
                  </div>
                  <div className="relative flex gap-x-3">
                    <div className="flex h-6 items-center">
                    ...
                    <div className="text-sm leading-6">
                      <label for="common" className="font-medium text-gray-900 capitalize"> thành viên</label>
              ...
              <fieldset >
                <legend className=" text-sm font-semibold leading-6 text-gray-900 capitalize">Cấp đề tài</legend>
                <div className="mt-2 space-y-2">
                  <div className="relative flex gap-x-3">
                    <div className="flex h-6 items-center">
                      <input id="main" name="main" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600" />
                    ...
                    <div className="text-sm leading-6">
                      <label for="main" className="font-medium text-gray-900 capitalize">cơ sở
</label>
                    </div>
                  </div>
                  <div className="relative flex gap-x-3">
                    ...
                    <div className="text-sm leading-6">
                      <label for="main" className="font-medium text-gray-900 capitalize"> Ban</label>
                    </div>
                  </div>
                  <div className="relative flex gap-x-3">
                    <div className="flex h-6 items-center">
                    ...
                    <div className="text-sm leading-6">
                      <label for="common" className="font-medium text-gray-900 capitalize"> nhà nước</label>
              ...
              <div className="col-span-full my-3">
                <label for="numberDecide" className="block text-sm font-medium leading-6 text-gray-900 capitalize">ngày bắt đầu</label>
                <div className="mt-2">
                  <input type="date" name="numberDecide" id="numberDecide" autocomplete="numberDecide" className="block w-full
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                </div>
              </div>
              <div className="col-span-full my-3">
                <label for="numberDecide" className="block text-sm font-medium leading-6 text-gray-900 capitalize">ngày kết thúc</label>
                <div className="mt-2">
                  <input type="date" name="numberDecide" id="numberDecide" autocomplete="numberDecide" className="block w-full
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                </div>
              ...
              <div className="col-span-full my-3">
                <label for="numberDecide" className="block text-sm font-medium leading-6 text-gray-900 capitalize">ngày nghiệm thu</label>
                <div className="mt-2">
                  <input type="date" name="numberDecide" id="numberDecide" autocomplete="numberDecide" className="block w-full
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                </div>
              ...
              <fieldset >
                <legend className=" text-sm font-semibold leading-6 text-gray-900 capitalize">Kết quả đạt được</legend>
                <div className="mt-2 space-y-2">
                  <div className="relative flex gap-x-3">
                    <div className="flex h-6 items-center">
                      <input id="main" name="main" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600" />
                    ...
                    <div className="text-sm leading-6">
                      <label for="main" className="font-medium text-gray-900 capitalize">đạt
</label>
                    </div>
                  </div>
                  <div className="relative flex gap-x-3">
                    ...
                    <div className="text-sm leading-6">
                      <label for="main" className="font-medium text-gray-900 capitalize"> Giỏi</label>
                    </div>
                  </div>
                  <div className="relative flex gap-x-3">
                    <div className="flex h-6 items-center">
                    ...
                    <div className="text-sm leading-6">
                      <label for="common" className="font-medium text-gray-900 capitalize"> xuất sắc</label>
