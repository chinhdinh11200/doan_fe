    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <main className='bg-white w-9/12 mx-auto p-8 shadow-md my-4'>
          <div className='py-5 mb-4 w-auto text-center'><span className='p-3 rounded-lg bg-slate-800 border text-white hover:text-slate-800 hover:bg-white hover:border-slate-800'> Thêm luận án/luận văn</span></div>
          <div className="w-full">

            <div className="border-b border-gray-900/10 pb-12">
              <div className="col-span-full">
                <label for="name" className="block text-sm font-medium leading-6 text-gray-900">Tên NCS/Học Viên/Sinh Viên</label>
                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              ...
              <div className="col-span-full">
                <label for="course" className="block text-sm font-medium leading-6 text-gray-900">Khóa Đào Tạo</label>
                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              ...
              <div className="col-span-full">
                <label for="numberDecide" className="block text-sm font-medium leading-6 text-gray-900">Số Quyết Định</label>
                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              ...
              <div className="col-span-full mb-3">
                <label for="CountPerson" className="block text-sm font-medium leading-6 text-gray-900">Số Người Hướng Dẫn</label>
                <div className="mt-2">
                ...
                <div className="mt-2 space-y-6">
                  <div className="relative flex gap-x-3">
                    ...
                    <div className="text-sm leading-6">
                      <label for="main" className="font-medium text-gray-900">Hướng dẫn chính</label>
                    </div>
                  </div>
                  <div className="relative flex gap-x-3">
                    <div className="flex h-6 items-center">
                    ...
                    <div className="text-sm leading-6">
                      <label for="common" className="font-medium text-gray-900">Hướng dẫn phụ</label>
