           ...
           text-white hover:text-slate-800 hover:bg-white hover:border-slate-800'>Thêm sách/giáo trình</span></div>
                    <div className="w-full">
                        ...
                        <div className="col-span-full my-3">
                                <label for="CountPerson" className="block text-sm font-medium leading-6 text-gray-900 capitalize">Tên sách/giáo trình</label>
                                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            ...
                            <div className="col-span-full my-3">
                                <label for="name" className="block text-sm font-medium leading-6 text-gray-900 capitalize">số xuất bản</label>
                                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            ...
                            <div className="col-span-full my-3">
                                <label for="course" className="block text-sm font-medium leading-6 text-gray-900 capitalize">số trang</label>
                                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            ...
                            <fieldset>
                                <legend className=" text-sm font-semibold leading-6 text-gray-900 capitalize">Chọn vai trò</legend>
