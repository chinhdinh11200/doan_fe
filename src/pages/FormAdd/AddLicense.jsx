    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <main className='bg-white w-9/12 mx-auto p-8 shadow-md my-4'>
          <div className='py-5 mb-4 w-auto text-center'><span className='p-3 rounded-lg bg-slate-800 border text-white hover:text-slate-800 hover:bg-white hover:border-slate-800'> Thêm bằng sáng chế/giải thưởng</span></div>
          <div className="w-full">

            <div className="border-b border-gray-900/10 pb-12">
              <div className="col-span-full">
                <label for="name" className="block text-sm font-medium leading-6 text-gray-900">Tên bằng sáng chế/giải thưởng</label>
                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              ...
              <div className="col-span-full">
                <label for="course" className="block text-sm font-medium leading-6 text-gray-900 capitalize">Số Quyết Định công nhận</label>
                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              ...
              <div className="col-span-full">
                <label for="numberDecide" className="block text-sm font-medium leading-6 text-gray-900 capitalize">Ngày Quyết Định công nhận</label>
                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              ...
              <div className="col-span-full mb-3">
                <label for="CountPerson" className="block text-sm font-medium leading-6 text-gray-900 capitalize">Số Người tham gia</label>
                <div className="mt-2">
             ...
             rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              ...
              <fieldset>
                <legend className=" text-sm font-semibold leading-6 text-gray-900">Chọn Vai Trò</legend>
                <div className="mt-2 space-y-6">
                  <div className="relative flex gap-x-3">
                    ...
                    <div className="text-sm leading-6">
                      <label for="main" className="font-medium text-gray-900">Tác giả chính</label>
                    </div>
                  </div>
                  <div className="relative flex gap-x-3">
                    <div className="flex h-6 items-center">
                    ...
                    <div className="text-sm leading-6">
                      <label for="common" className="font-medium text-gray-900">Thành viên</label>
