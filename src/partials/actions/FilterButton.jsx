        ...
        <div ref={dropdown}>
          ...
          <ul className="mb-4">
            <li className="py-1 px-3">
              <label className="flex items-center">
                ...
                <span className="text-sm font-medium ml-2">Chỉnh sửa nhiều nhất</span>
              </label>
            </li>
            <li className="py-1 px-3">
              <label className="flex items-center">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm font-medium ml-2">Được thêm gần đây</span>
              </label>
            </li>
            <li className="py-1 px-3">
              <label className="flex items-center">
                <input type="checkbox" className="form-checkbox" />
                <span className="text-sm font-medium ml-2">Chỉnh sửa gần đây</span>
              </label>
            </li>
          </ul>
          <div className="py-2 px-3 border-t border-slate-200 bg-slate-50">
            <ul className="flex items-center justify-between">
              <li>
                <button className="btn-xs bg-white border-slate-200 hover:border-slate-300 text-slate-500 hover:text-slate-600">Xóa</button>
              </li>
              <li>
